...
public class Picture extends SimplePicture {
    ...
    /**
     * Method that mirrors the picture around a diagonal
     */
    ...
    public void mirrorArms() {
        ...
        for (int col = 105; col < 295; col++) {
            // loop from 13 to just before the mirror point
            for (int row = 195 - 25; row < mirrorPoint - 25; row++) {
                topPixel = pixels[row][col];
                bottomPixel = pixels[mirrorPoint - row + 135][col];
                bottomPixel.setColor(topPixel.getColor());
            }
        }
    }
    ...
    public void myCollage() {
        ...
        Picture archMirror = new Picture(flower2);
        archMirror.mirrorVertical();
        this.copy(archMirror, 0, 300);

        Picture flowerNoBlue = new Picture(flower1);
        flowerNoBlue.zeroBlue();
        this.copy(flowerNoBlue, 100, 300);

        Picture robotHorizontal = new Picture(robot);
        robotHorizontal.mirrorHorizontal();
        this.copy(robotHorizontal, 200, 300);

        Picture caterpillarNegate = new Picture(caterpillar);
        caterpillarNegate.negate();
        this.copy(caterpillarNegate, 300, 300);
